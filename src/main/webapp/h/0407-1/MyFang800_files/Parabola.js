...
js_parabola = function () {
    var funParabola = function (element, target, options) {
        ...
        */
        ...
        var defaults = {
            speed: 400, // 每帧移动的像素大小，每帧（对于大部分显示屏）大约16~17毫秒
    ...
    funDrag(target);
    // 抛物线运动的触发
    $(".js_parabola").click(function () {
        console.log(1);
        $(".js_parabola").unbind('click');
        console.log(2);
        element.style.marginLeft = "91px";
        element.style.marginTop = "-29px";
        console.log(3);
        //var scrollLeft = document.documentElement.scrollLeft || document.body.scrollLeft || 0,
        //    scrollTop = document.documentElement.scrollTop || document.body.scrollTop || 0;
        parabola.init(); console.log(4);
